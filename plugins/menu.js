 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	{title: `${pmenus} S&K BOT`, rowId: ".rules", description: `Peraturan menggunakan bot!`},
	{title: `${pmenus} REQUEST FITUR`, rowId: ".request", description: "Request/report error"},
	]
    },{
	title: `${htki} 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 ${htka}`,
	rows: [
	...
	title: `${htki} 𝐌𝐄𝐍𝐔 𝐖𝐀𝐍𝐍𝐁𝐎𝐓𝐙-𝐌𝐃${htka}`,
	rows: [
	...
	{title: `${pmenus} All Sound Menu`, rowId: ".soundmenu", description: "Ubah Audio dengan Filter"},
...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'www.instagram.com/hyuura-official',
    ...
    title: "Now Playing...",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/d04869d76f47ed7e38aed.jpg')).buffer(),
...
let dj2 = "dj2"
let dj3 = "dj3"
let snd = `${pickRandom([dj1,dj2,dj3])}`
let audio = `https://raw.githubusercontent.com//Wannzx/sound/master/${snd}.mp3`
            ...
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://instagram.com/wannzx_133'
                    }
                },
                {
                    urlButton: {
